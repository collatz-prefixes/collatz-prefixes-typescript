...
const ecfrip_path = JSON.stringify(iterative_path_extension(n, riptree_prefix_find));
const ecfrip_pf = JSON.stringify(iterative_prefix(n, riptree_prefix_find));
const ecfpip_path = JSON.stringify(iterative_path_extension(n, piptree_prefix_find));
